...
Prefeitura RS Caxias do Sul: Certidão Negativa de Débitos segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_rs_caxias_do_sul_cnd@mcp.ai](mailto:pref_rs_caxias_do_sul_cnd@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
